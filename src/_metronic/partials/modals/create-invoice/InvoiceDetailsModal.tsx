...
import {
  InvidualInvoice,
  InvoiceModel,
} from '../../../../app/modules/invoicerModules/invoices/_models'
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        <div className='card bg-light p-4'>
          ...
          <div className='row'>
            <div className='col-sm-6'>
              <div className='row'>
                <div className='col-6'><KTIcon iconName='user' className='fs-1 text-primary text-lg-start symbol-50px' /> Name:</div>
                <div className='col-6'>
                  <h6>
                    {`${
          ...
          <div className='row'>
            <div className='col-sm-6'>
              <div className='row'>
                <div className='col-6'><KTIcon iconName='sms' className='fs-1 text-primary text-lg-start symbol-50px' /> Email:</div>
                <div className='col-6'>
                  <h6>
          ...
          <div className='row'>
            <div className='col-sm-6'>
              <div className='row'>
                <div className='col-6'><KTIcon iconName='phone' className='fs-1 text-primary text-lg-start symbol-50px' /> Phone:</div>
                <div className='col-6'>
                  <h6>
          ...
          <div className='row'>
            <div className='col-sm-6'>
              <div className='row'>
                <div className='col-6'><KTIcon iconName='profile-user' className='fs-1 text-primary text-lg-start symbol-50px' /> Gender:</div>
                <div className='col-6'>
                  <h6>
                    {(modalContent &&
        ...
        <div className='p-4'>              
        <h2 className='my-3'><KTIcon iconName='briefcase' className='fs-1 text-primary text-lg-start symbol-50px' /> Prescriptions</h2>
        ...
        <div className='p-4'>
          <h2><KTIcon iconName='purchase' className='fs-1 text-primary text-lg-start symbol-50px' /> Inventory Items</h2>
          <div className='card-body py-3'>
            {/* begin::Table container */}
            <div className='table-responsive'>
              {/* begin::Table */}
                    ...
                    modalContent.inventory_items.map((element, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>{(element.inventory_item && element.inventory_item.is_active ? "Active" : "Not Active") || ''}</td>
                          <td>
        ...
        <h2><KTIcon iconName='dollar' className='fs-1 text-primary text-lg-start symbol-50px' /> Invoice Payments</h2>
        <div className='card-body py-3'>
          {/* begin::Table container */}
          <div className='table-responsive'>
            {/* begin::Table */}
        ...
        <div className=''>
            ...
            <div className='table-responsive'>
              ...
              <table className='table align-middle gs-0 gy-4'>
                ...
                <tbody>
                        ...
                        <tr>
                          <td><h3 className='text-primary'>{`${(modalContent && modalContent.total) || '-'}`}</h3></td>
                          <td><h3 className='text-primary'>{`${(modalContent && modalContent.discount) || '-'}`}</h3></td>
                          <td><h3 className='text-primary'>{`${(modalContent && modalContent.advance) || '-'}`}</h3></td>
                          <td><h3 className='text-primary'>{`${(modalContent && modalContent.balance) || '-'}`}</h3></td>
                        </tr>
         ...
         <div className='card bg-light p-4 mt-3'>
          <div className='d-flex'>
            <h2><KTIcon iconName='calendar-2' className='fs-1 text-primary text-lg-start symbol-50px' /> Dates</h2>
          </div>
          <div className='row mt-2'>
            <div className='col-sm-6'>
              <div className='row'>
                <div className='col-6'><KTIcon iconName='calendar' className='fs-1 text-primary text-lg-start symbol-50px' /> Invoice Date:</div>
                <div className='col-6'>
                <div className='col-8'>
          ...
          <div className='row'>
            <div className='col-sm-6'>
              <div className='row'>
                <div className='col-6'><KTIcon iconName='calendar-tick' className='fs-1 text-primary text-lg-start symbol-50px' /> Delivery Date:</div>
                <div className='col-6'>
          ...
          <h2 className='mt-4'><KTIcon iconName='message-text-2' className='fs-1 text-primary text-lg-start symbol-50px' /> Remarks</h2>
          <div className='col-6'>
